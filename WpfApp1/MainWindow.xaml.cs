...
namespace Ttrad
{
    public partial class MainWindow : Window
    {
        ...
        {
            // Отмена ластика (восстановление снимка канвы)
            ...
            // Отмена карандаша (удаление последнего штриха)
